...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center #FFFFFF dark:bg-[#0D0E12] p-3 sm:p-4 lg:p-6 relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 sm:top-20 left-4 sm:left-10 w-40 sm:w-56 lg:w-72 h-40 sm:h-56 lg:h-72 bg-[#F1F5F9]/50 dark:bg-[#F2DD50]/15 rounded-full blur-3xl"></div>
      ...
      <div className={`relative z-10 text-center max-w-5xl w-full transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="mb-6 sm:mb-8">
          <div className="inline-block transform hover:scale-105 transition-transform duration-300">
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-3 sm:mb-4 #1E293B dark:text-[#EAE5DF] drop-shadow-sm">
              {t('welcome.title')}
            </h1>
          </div>
          <p className="text-lg sm:text-xl md:text-2xl #475569 dark:text-[#64748B] mt-4 sm:mt-6 font-medium max-w-2xl mx-auto px-2">
            {t('welcome.subtitle')}
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 mt-8 sm:mt-12 mb-10 sm:mb-16 px-4 sm:px-0">
          <Button
            ...
            className="w-full sm:w-auto min-w-0 sm:min-w-56 h-12 sm:h-14 text-base sm:text-lg shadow-lg hover:shadow-blue-500/25 transform hover:scale-105 transition-all bg-[#F2DD50] hover:bg-[#8E7356] text-white flex items-center justify-center gap-2"
          >
            {t('welcome.signup')}
          ...
          <Button
            ...
            variant="secondary"
            onClick={handleLogin}
            className="w-full sm:w-auto min-w-0 sm:min-w-56 h-12 sm:h-14 text-base sm:text-lg border-2 border-gray-300 dark:border-[#2A2B36] hover:border-[#F2DD50] dark:hover:border-[#F2DD50] transform hover:scale-105 transition-all flex items-center justify-center gap-2"
          >
        ...
        <div className="mt-10 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 px-2 sm:px-0">
          <div className="group relative p-5 sm:p-6 lg:p-8 bg-white dark:bg-[#15161C] rounded-xl sm:rounded-2xl border #E2E8F0 dark:border-[#1C1D24] shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="group relative p-5 sm:p-6 lg:p-8 bg-white dark:bg-[#15161C] rounded-xl sm:rounded-2xl border #E2E8F0 dark:border-[#1C1D24] shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 sm:col-span-2 lg:col-span-1">
            <div className="relative">
        ...
        {/* Trust badges */}
        <div className="mt-10 sm:mt-16 flex flex-wrap justify-center gap-3 sm:gap-6 #475569 dark:text-[#44454F] px-2">
          <div className="flex items-center gap-1.5 sm:gap-2 bg-white dark:bg-[#15161C] px-3 sm:px-4 py-1.5 sm:py-2 rounded-full shadow-sm border #E2E8F0 dark:border-[#1C1D24]">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 bg-white dark:bg-[#15161C] px-3 sm:px-4 py-1.5 sm:py-2 rounded-full shadow-sm border #E2E8F0 dark:border-[#1C1D24]">
            <FiTrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-[#F2DD50]" />
        ...
        {/* Footer text */}
        <p className="mt-8 sm:mt-12 text-xs sm:text-sm text-gray-400 dark:#475569 px-4">
