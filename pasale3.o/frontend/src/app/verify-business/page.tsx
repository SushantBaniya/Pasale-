...
export default function VerifyBusinessPage() {
  ...
  // Details Step
  return (
    <div className="min-h-screen flex items-center justify-center #FAF7F3 dark:bg-[#111111] p-3 sm:p-4 py-6 sm:py-8 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-64 sm:w-96 h-64 sm:h-96 bg-[#D4623A]/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-64 sm:w-96 h-64 sm:h-96 bg-purple-500/10 rounded-full blur-3xl"></div>
      ...
      <div className={`w-full max-w-2xl transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="text-center mb-4 sm:mb-6">
          <h1 className="text-2xl sm:text-4xl font-black text-[#D4623A] dark:text-[#D4623A]">Pasale</h1>
          <p className="text-sm sm:text-base #8A7060 dark:text-[#555555] mt-1 sm:mt-2">{t('verification.businessTitle')}</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#1A1A1A] rounded-2xl sm:rounded-3xl shadow-xl border #E5D8CC dark:border-[#222222] overflow-hidden">
          {/* Section Tabs */}
          <div className="flex border-b #E5D8CC dark:border-[#222222]">
            <button
              ...
              className={`flex-1 py-3 sm:py-4 px-3 sm:px-4 text-xs sm:text-sm font-semibold flex items-center justify-center gap-1.5 sm:gap-2 transition-colors ${
                activeSection === 'business'
                  ? 'text-[#D4623A] dark:text-[#D4623A] border-b-2 border-blue-600 dark:border-blue-400 bg-[#FDF1EC] dark:bg-[#D4623A]/15'
                  : '#8A7060 dark:text-[#555555] hover:text-gray-700 dark:hover:text-gray-300'
              }`}
            >
              ...
              <div className="space-y-3 sm:space-y-4 animate-fadeIn">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                        ...
                        className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 ${
                          errors.businessName ? 'border-red-500' : '#E5D8CC dark:border-[#333333] focus:border-gray-500'
                        } bg-white dark:bg-[#222222] #3D2B1A dark:text-[#E0E0E0] focus:outline-none transition-colors`}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 #E5D8CC dark:border-[#333333] focus:border-[#D4623A] bg-white dark:bg-[#222222] #3D2B1A dark:text-[#E0E0E0] focus:outline-none transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 ${
                          errors.ownerName ? 'border-red-500' : '#E5D8CC dark:border-[#333333] focus:border-gray-500'
                        } bg-white dark:bg-[#222222] #3D2B1A dark:text-[#E0E0E0] focus:outline-none transition-colors`}
                      />
                    </div>
                  ...
                  <button
                    type="button"
                    onClick={() => setActiveSection('contact')}
                    className="w-full py-2.5 sm:py-3 #EDE5DA dark:bg-[#222222] text-sm sm:text-base text-gray-700 dark:text-[#CCCCCC] font-semibold rounded-lg sm:rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex items-center justify-center gap-1.5 sm:gap-2"
                  >
              ...
              {activeSection === 'contact' && (
                <div className="space-y-3 sm:space-y-4 animate-fadeIn">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 ${
                          errors.email ? 'border-red-500' : '#E5D8CC dark:border-[#333333] focus:border-gray-500'
                        } bg-white dark:bg-[#222222] #3D2B1A dark:text-[#E0E0E0] focus:outline-none transition-colors`}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 ${
                          errors.phone ? 'border-red-500' : '#E5D8CC dark:border-[#333333] focus:border-gray-500'
                        } bg-white dark:bg-[#222222] #3D2B1A dark:text-[#E0E0E0] focus:outline-none transition-colors`}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 ${
                          errors.address ? 'border-red-500' : '#E5D8CC dark:border-[#333333] focus:border-gray-500'
                        } bg-white dark:bg-[#222222] #3D2B1A dark:text-[#E0E0E0] focus:outline-none transition-colors resize-none`}
                      />
                    </div>
                  ...
                  <button
                    type="button"
                    onClick={() => setActiveSection('business')}
                    className="w-full py-2.5 sm:py-3 text-sm sm:text-base #8A7060 dark:text-[#555555] font-medium hover:#3D2B1A dark:hover:text-gray-200 flex items-center justify-center gap-1.5 sm:gap-2"
                  >
                    <FiArrowLeft className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
          ...
          {/* Footer */}
          <p className="text-center text-xs sm:text-sm #8A7060 dark:text-[#555555] p-4 sm:p-6 pt-0">
