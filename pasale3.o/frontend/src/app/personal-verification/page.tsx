    ...
    <div className="min-h-screen flex items-center justify-center #F4F0EA dark:bg-[#0D0E12] p-3 sm:p-4 relative overflow-hidden">
      ...
      <div className={`w-full max-w-lg transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="text-center mb-4 sm:mb-6">
          <h1 className="text-2xl sm:text-4xl font-black text-[#A3876A] dark:text-[#A3876A]">Pasale</h1>
          <p className="text-sm sm:text-base #6B7280 dark:text-[#44454F] mt-1 sm:mt-2">{t('verification.personalTitle')}</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#15161C] rounded-2xl sm:rounded-3xl shadow-xl border #DDD7CC dark:border-[#1C1D24] overflow-hidden">
            ...
            <form onSubmit={handleProfileSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div className="relative">
                  ...
                  >
                    {photo ? (
                      ...
                      <div className="w-20 h-20 sm:w-28 sm:h-28 rounded-full #E3DDD2 dark:bg-[#1C1D24] flex items-center justify-center border-4 border-white dark:border-[#1C1D24] shadow-lg group-hover:bg-gray-200 dark:group-hover:bg-gray-600 transition-colors">
                        <FiUser className="w-8 h-8 sm:w-12 sm:h-12 text-gray-400 dark:#6B7280" />
                      </div>
                    )}
                    <div className="absolute bottom-0 right-0 bg-gray-700 dark:bg-[#22232C] text-white p-2 sm:p-2.5 rounded-full shadow-lg group-hover:bg-gray-800 dark:group-hover:#F4F0EA0 transition-colors">
              ...
              <p className="text-center text-xs sm:text-sm #6B7280 dark:text-[#44454F]">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 ${
                        errors.name ? 'border-red-500' : '#DDD7CC dark:border-[#2A2B36] focus:border-[#A3876A]'
                      } bg-white dark:bg-[#1C1D24] #1A1C20 dark:text-[#EAE5DF] focus:outline-none transition-colors`}
                    />
                  </div>
        ...
        {/* Footer */}
        <p className="text-center text-xs sm:text-sm #6B7280 dark:text-[#44454F] mt-4 sm:mt-6">
