      ...
      case 'request':
        return (
          <>
            ...
            {/* Method Toggle */}
            <div className="flex gap-1.5 sm:gap-2 p-1 #F8FAFC dark:bg-[#15161C] rounded-lg sm:rounded-xl mb-4 sm:mb-6">
              <button
                type="button"
        ...
        return (
          <>
            ...
            <button
              ...
              className="w-full mt-3 sm:mt-4 py-2.5 sm:py-3 text-sm sm:text-base #475569 dark:text-[#44454F] font-medium hover:#1E293B dark:hover:text-gray-200 flex items-center justify-center gap-1.5 sm:gap-2"
            >
        ...
        return (
          <>
            ...
            <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 ${
                      errors.newPassword ? 'border-red-500' : '#E2E8F0 dark:border-[#2A2B36] focus:border-[#F2DD50]'
                    } bg-white dark:bg-[#1C1D24] #1E293B dark:text-[#EAE5DF] focus:outline-none transition-colors`}
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:#475569 dark:hover:text-gray-300"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-3 sm:py-3.5 text-sm sm:text-base rounded-lg sm:rounded-xl border-2 ${
                      errors.confirmPassword ? 'border-red-500' : '#E2E8F0 dark:border-[#2A2B36] focus:border-[#F2DD50]'
                    } bg-white dark:bg-[#1C1D24] #1E293B dark:text-[#EAE5DF] focus:outline-none transition-colors`}
                  />
                  <button
                    type="button"
              ...
              <div className="#F8FAFC dark:bg-[#1C1D24] rounded-lg sm:rounded-xl p-3 sm:p-4">
                <p className="text-xs sm:text-sm font-medium text-gray-700 dark:text-[#64748B] mb-1.5 sm:mb-2">{t('forgotPassword.passwordMustContain')}:</p>
                <ul className="text-xs sm:text-sm space-y-0.5 sm:space-y-1">
                  <li className={`flex items-center gap-1.5 sm:gap-2 ${formData.newPassword.length >= 8 ? 'text-green-600 dark:text-green-400' : '#475569 dark:text-[#44454F]'}`}>
                  ...
                  <li className={`flex items-center gap-1.5 sm:gap-2 ${/[A-Z]/.test(formData.newPassword) ? 'text-green-600 dark:text-green-400' : '#475569 dark:text-[#44454F]'}`}>
                  ...
                  <li className={`flex items-center gap-1.5 sm:gap-2 ${/\d/.test(formData.newPassword) ? 'text-green-600 dark:text-green-400' : '#475569 dark:text-[#44454F]'}`}>
    ...
    <div className="min-h-screen flex items-center justify-center #FFFFFF dark:bg-[#0D0E12] p-3 sm:p-4 relative overflow-hidden">
      ...
      <div className={`w-full max-w-md transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        {step !== 'success' && (
          <Link
            to="/login"
            className="inline-flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base #475569 dark:text-[#44454F] hover:#1E293B dark:hover:text-gray-200 mb-4 sm:mb-6 font-medium"
          >
            <FiArrowLeft className="w-4 h-4" />
            Back to Login
          </Link>
        ...
        <div className="bg-white dark:bg-[#15161C] rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 lg:p-8 border #E2E8F0 dark:border-[#1C1D24]">
          {renderStep()}
        </div>
