          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/30">
                ...
                <th className="py-3 px-5 text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">INVOICE NO</th>
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={6} className="py-16 text-center">
                    <p className="text-sm text-gray-400 dark:text-gray-500 mb-2">No sales invoices found</p>
                    <button
                      onClick={() => navigate('/sales/new')}
                ...
                filtered.map((billing) => (
                  ...
                  >
                    ...
                    <td className="py-3.5 px-5 text-sm font-medium text-blue-600 dark:text-blue-400">
                    ...
                    <td className="py-3.5 px-5 text-sm font-semibold text-teal-600 dark:text-teal-400 text-right">
