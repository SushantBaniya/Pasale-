  ...
  return (
    <div className="max-w-[1300px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <h1 className="text-xl font-bold #1A1C20 dark:text-[#EAE5DF]">Sales Invoices</h1>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b #DDD7CC dark:border-[#1C1D24] #F4F0EA/50 dark:bg-[#0D0E12]/30">
                ...
                <th className="py-3 px-5 text-[11px] font-bold #6B7280 dark:text-[#44454F] uppercase tracking-wider">INVOICE NO</th>
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={6} className="py-16 text-center">
                    <p className="text-sm text-gray-400 dark:#6B7280 mb-2">No sales invoices found</p>
                    <button
                      onClick={() => navigate('/sales/new')}
                ...
                filtered.map((billing) => (
                  ...
                  >
                    ...
                    <td className="py-3.5 px-5 text-sm font-medium text-[#A3876A] dark:text-[#A3876A]">
