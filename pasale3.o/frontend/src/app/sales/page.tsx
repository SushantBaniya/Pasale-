  ...
  return (
    <div className="max-w-[1300px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <h1 className="text-xl font-medium #1E293B dark:text-[#EAE5DF]">Sales Invoices</h1>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b #E2E8F0 dark:border-[#1C1D24] #FFFFFF/50 dark:bg-[#0D0E12]/30">
                ...
                <th className="py-3 px-5 text-[11px] font-medium #475569 dark:text-[#44454F] uppercase tracking-wider">INVOICE NO</th>
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={6} className="py-16 text-center">
                    <p className="text-sm text-gray-400 dark:#475569 mb-2">No sales invoices found</p>
                    <button
                      onClick={() => navigate('/sales/new')}
