...
export default function ProfilePage() {
  ...
  const stats = [
    ...
    { label: 'Transactions', value: '156', icon: FiActivity, color: 'text-[#D4623A] dark:text-[#D4623A]', bg: 'bg-[#FDF1EC] dark:bg-[#D4623A]/20' },
    ...
    { label: 'Verified', value: 'Yes', icon: FiCheckCircle, color: 'text-[#D4623A] dark:text-[#D4623A]', bg: 'bg-[#FDF1EC] dark:bg-[#D4623A]/20' },
  ];

  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      {/* Hero Section with White Theme */}
      <div className="relative h-36 sm:h-48 lg:h-56 bg-white dark:bg-[#1A1A1A] border-b #E5D8CC dark:border-[#222222] shadow-sm">
        <div className="absolute inset-0 overflow-hidden opacity-50 dark:opacity-20">
          <div className="absolute -top-20 -right-20 w-40 sm:w-64 h-40 sm:h-64 bg-[#FDF1EC] dark:bg-blue-900 rounded-full blur-3xl"></div>
        ...
        <div className="absolute top-3 sm:top-4 left-3 sm:left-4 z-10">
          <Button
            ...
            size="sm"
            onClick={() => navigate(-1)}
            className="bg-white/50 dark:bg-[#1A1A1A]/50 backdrop-blur-sm #E5D8CC dark:border-[#222222] text-gray-700 dark:text-[#CCCCCC] hover:bg-white dark:hover:bg-gray-700"
          >
            ...
            <div className="relative group mx-auto sm:mx-0 shrink-0">
              {(isEditing ? editData.photo : userProfile.photo) ? (
                <img
                  ...
                  alt="Profile"
                  className="w-24 h-24 sm:w-32 sm:h-32 lg:w-36 lg:h-36 rounded-full object-cover border-4 border-white dark:border-[#222222] shadow-lg"
                />
              ) : (
                <div className="w-24 h-24 sm:w-32 sm:h-32 lg:w-36 lg:h-36 rounded-full bg-linear-to-br from-[#D4623A] to-[#8A3A1E] flex items-center justify-center border-4 border-white dark:border-[#222222] shadow-lg">
                  <FiUser className="w-10 h-10 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-white" />
                </div>
              )}
              
              {isEditing && (
                <label className="absolute bottom-1 right-1 sm:bottom-2 sm:right-2 bg-[#D4623A] hover:bg-[#B8502E] text-white p-2 sm:p-2.5 rounded-full cursor-pointer shadow-lg transition-all duration-200 group-hover:scale-110">
            ...
            <div className="flex-1 text-center sm:text-left min-w-0">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                <div className="min-w-0">
                  <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold #3D2B1A dark:text-[#E0E0E0] mb-1 truncate">
                    {userProfile.name}
                  </h1>
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-1.5 sm:gap-2 #8A7060 dark:text-[#555555]">
                    <span className="inline-flex items-center gap-1 px-2 sm:px-2.5 py-0.5 sm:py-1 bg-[#FDF1EC] dark:bg-[#D4623A]/20 text-[#D4623A] dark:text-[#D4623A] rounded-full text-xs sm:text-sm font-medium">
                ...
                {!isEditing ? (
                  <Button
                    ...
                    className="bg-[#D4623A] hover:bg-[#B8502E] text-white shadow-md"
                    size="sm"
                  >
                ...
                {stats.map((stat, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555] truncate">{stat.label}</p>
                    </div>
                  );
                })}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <Card className="p-4 sm:p-6 shadow-lg border-0">
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-[#FDF1EC] dark:bg-[#D4623A]/20 flex items-center justify-center shrink-0">
                <FiUser className="w-4 h-4 sm:w-5 sm:h-5 text-[#D4623A] dark:text-[#D4623A]" />
              </div>
              <h2 className="text-base sm:text-lg font-bold #3D2B1A dark:text-[#E0E0E0]">
                Personal Information
              </h2>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              {isEditing ? (
                <>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-[#CCCCCC] mb-1 sm:mb-1.5">
                      Full Name
                    </label>
                    <Input
                      value={editData.name}
                ...
                <>
                  <div className="flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#FDF1EC] dark:bg-[#D4623A]/30 flex items-center justify-center shrink-0">
                      <FiUser className="w-4 h-4 sm:w-5 sm:h-5 text-[#D4623A] dark:text-[#D4623A]" />
                    </div>
                    <div className="min-w-0">
                      <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555]">Full Name</p>
                      <p className="text-sm sm:text-base font-semibold #3D2B1A dark:text-[#E0E0E0] truncate">{userProfile.name}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                    ...
                    <div className="min-w-0">
                      <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555]">Email Address</p>
                      <p className="text-sm sm:text-base font-semibold #3D2B1A dark:text-[#E0E0E0] truncate">{userProfile.email || 'Not provided'}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                    ...
                    <div className="min-w-0">
                      <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555]">Phone Number</p>
                      <p className="text-sm sm:text-base font-semibold #3D2B1A dark:text-[#E0E0E0] truncate">{userProfile.phone || 'Not provided'}</p>
                    </div>
                  </div>
                  {userProfile.panNumber && (
                    <div className="flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                      ...
                      <div className="min-w-0">
                        <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555]">PAN Number</p>
                        <p className="text-sm sm:text-base font-semibold #3D2B1A dark:text-[#E0E0E0] truncate">{userProfile.panNumber}</p>
                      </div>
                    </div>
                  )}
                </>
            ...
            <Card className="p-4 sm:p-6 shadow-lg border-0">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555]">Business Name</p>
                    <p className="text-sm sm:text-base font-semibold #3D2B1A dark:text-[#E0E0E0] truncate">
                ...
                <div className="flex items-center gap-3 sm:gap-4 p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555]">Business Address</p>
                    <p className="text-sm sm:text-base font-semibold #3D2B1A dark:text-[#E0E0E0] truncate">
                      Kathmandu, Nepal
                    </p>
                  </div>
          ...
          <Card className={`p-4 sm:p-6 shadow-lg border-0 ${userType !== 'business' ? 'lg:col-span-1' : ''}`}>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                  <FiCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 shrink-0" />
                  <div className="min-w-0">
                    <p className="text-sm sm:text-base font-medium #3D2B1A dark:text-[#E0E0E0]">Email Verified</p>
                    <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555] hidden sm:block">Your email is verified</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                  <FiCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 shrink-0" />
                  <div className="min-w-0">
                    <p className="text-sm sm:text-base font-medium #3D2B1A dark:text-[#E0E0E0]">Phone Verified</p>
                    <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555] hidden sm:block">Your phone is verified</p>
                  </div>
                </div>
                <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-green-400 text-[10px] sm:text-xs font-medium rounded-full shrink-0">
                  Active
              ...
              <div className="flex items-center justify-between p-2.5 sm:p-3 #FAF7F3 dark:bg-[#1A1A1A]/50 rounded-lg sm:rounded-xl">
                <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                  <FiAward className="w-4 h-4 sm:w-5 sm:h-5 text-[#D4623A] shrink-0" />
                  <div className="min-w-0">
                    <p className="text-sm sm:text-base font-medium #3D2B1A dark:text-[#E0E0E0]">Account Status</p>
                    <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555] hidden sm:block">Premium member</p>
                  </div>
                </div>
                <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-[#FDF1EC] dark:bg-[#D4623A]/30 text-[#D4623A] dark:text-[#D4623A] text-[10px] sm:text-xs font-medium rounded-full shrink-0">
                  Premium
                </span>
              </div>
            </div>
            ...
            <Button
              variant="outline"
              size="sm"
              className="w-full mt-3 sm:mt-4 border-gray-300 dark:border-[#333333]"
              onClick={() => navigate('/settings')}
            >
              ...
              <div className="space-y-2 sm:space-y-3">
                {[
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-center gap-2 sm:gap-3 p-1.5 sm:p-2 hover:#FAF7F3 dark:hover:bg-gray-800/50 rounded-lg transition-colors"
                    >
                      <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full #EDE5DA dark:bg-[#1A1A1A] flex items-center justify-center shrink-0">
                        <Icon className="w-3.5 h-3.5 sm:w-4 sm:h-4 #8A7060 dark:text-[#555555]" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs sm:text-sm font-medium #3D2B1A dark:text-[#E0E0E0] truncate">
                          {activity.action}
                        </p>
                        <p className="text-[10px] sm:text-xs #8A7060 dark:text-[#555555]">{activity.time}</p>
                      </div>
                    </div>
                  );
                })}
