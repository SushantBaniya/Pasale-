    ...
    return (
      <div className="p-6 max-w-5xl mx-auto animate-in slide-in-from-right duration-300">
        <button
          ...
          className="flex items-center gap-2 #475569 hover:text-indigo-600 mb-6 transition-colors group"
        >
          ...
          <div className="space-y-6">
            {pendingOrders.map(order => (
              <Card key={order.id} className="overflow-hidden border-0 shadow-xl bg-white">
                <div className="p-6 border-b #FFFFFF/50 flex items-center justify-between">
                ...
                <div className="p-6 bg-white border-t #E2E8F0 flex items-center justify-between">
                  <p className="#475569 text-sm font-medium">Ready to finalize this transaction?</p>
                  <Button
            ...
            <form onSubmit={handleAddCounter} className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 border #E2E8F0 rounded-xl #FFFFFF #1E293B focus:outline-none focus:border-indigo-600 resize-none h-32"
                />
              </div>
