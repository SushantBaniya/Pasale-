...
export const AddPartyDialog: React.FC<AddPartyDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="w-full max-w-3xl bg-white dark:bg-[#111111] rounded-2xl max-h-[95vh] overflow-hidden shadow-2xl">
        {/* Header with gradient */}
        <div
          className={`${isCustomer ? 'bg-gradient-to-r from-[#D4623A] to-blue-700' : 'bg-gradient-to-r from-purple-600 to-purple-700'} px-6 py-5 text-white`}
        >
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[calc(95vh-180px)]">
          ...
          {!isEdit && !defaultType && (
            <div className="p-6 border-b #E5D8CC dark:border-[#222222] #FAF7F3 dark:bg-[#1A1A1A]/50">
              <label className="block text-sm font-bold mb-3 text-gray-700 dark:text-[#CCCCCC]">
                ...
                <button
                  ...
                  className={`p-5 rounded-xl border-2 transition-all flex items-center gap-4 ${
                    formData.type === 'customer'
                      ? 'bg-[#FDF1EC] dark:bg-[#D4623A]/15 border-[#D4623A] shadow-lg scale-[1.02]'
                      : 'bg-white dark:bg-[#1A1A1A] border-gray-300 dark:border-[#333333] hover:border-blue-400'
                  }`}
                >
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                      formData.type === 'customer'
                        ...
                        : '#EDE5DA dark:bg-[#222222] #8A7060'
                    }`}
                  >
                    <FiUser className="w-6 h-6" />
                  </div>
                  <div className="text-left">
                    <span className="font-bold #3D2B1A dark:text-[#E0E0E0] block">
                      Customer
                    </span>
                    <span className="text-xs #8A7060 dark:text-[#555555]">
                      Buys from you
                    </span>
                  </div>
                </button>
                <button
                  ...
                  className={`p-5 rounded-xl border-2 transition-all flex items-center gap-4 ${
                    formData.type === 'supplier'
                      ...
                      : 'bg-white dark:bg-[#1A1A1A] border-gray-300 dark:border-[#333333] hover:border-purple-400'
                  }`}
                >
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center ${
          ...
          {/* Tabs */}
          <div className="border-b #E5D8CC dark:border-[#222222] px-6">
                ...
                <button
                  ...
                  className={`px-4 py-3 font-medium text-sm transition-colors border-b-2 -mb-px ${
                    activeTab === tab
                      ? `${
                          isCustomer
                            ? 'border-[#D4623A] text-[#D4623A]'
                            : 'border-purple-500 text-purple-600'
                        }`
                      : 'border-transparent #8A7060 hover:text-gray-700 dark:hover:text-gray-300'
                  }`}
                >
          ...
          <div className="p-6 space-y-6">
            ...
            {activeTab === 'basic' && (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-semibold mb-2 text-gray-700 dark:text-[#CCCCCC]">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-[#1A1A1A] #3D2B1A dark:text-[#E0E0E0] focus:outline-none focus:ring-2 focus:ring-[#D4623A] ${
                        validationErrors.name ? 'border-red-500' : 'border-gray-300 dark:border-[#333333]'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-[#1A1A1A] #3D2B1A dark:text-[#E0E0E0] border-gray-300 dark:border-[#333333] focus:outline-none focus:ring-2 focus:ring-[#D4623A]"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-[#1A1A1A] #3D2B1A dark:text-[#E0E0E0] focus:outline-none focus:ring-2 focus:ring-[#D4623A] ${
                        validationErrors.phone ? 'border-red-500' : 'border-gray-300 dark:border-[#333333]'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-[#1A1A1A] #3D2B1A dark:text-[#E0E0E0] focus:outline-none focus:ring-2 focus:ring-[#D4623A] ${
                        validationErrors.email ? 'border-red-500' : 'border-gray-300 dark:border-[#333333]'
                      }`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-[#1A1A1A] #3D2B1A dark:text-[#E0E0E0] focus:outline-none focus:ring-2 focus:ring-[#D4623A] resize-none ${
                      validationErrors.address ? 'border-red-500' : 'border-gray-300 dark:border-[#333333]'
                    }`}
                    rows={2}
            ...
            {activeTab === 'financial' && (
              <>
                ...
                <div
                  className={`${
                    isCustomer ? 'bg-[#FDF1EC] dark:bg-[#D4623A]/15' : 'bg-purple-50 dark:bg-purple-900/20'
                  } p-6 rounded-xl border ${
                    isCustomer
                      ? 'border-[#D4623A]/30 dark:border-[#D4623A]/50'
                      : 'border-purple-200 dark:border-purple-800'
                  }`}
                >
                  <h3 className="font-bold #3D2B1A dark:text-[#E0E0E0] mb-4 flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="relative">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 #8A7060 font-semibold">
                          रु.
                        </span>
                        <input
                          type="number"
                          ...
                          className="w-full pl-12 pr-4 py-3 border-2 rounded-xl bg-white dark:bg-[#1A1A1A] #3D2B1A dark:text-[#E0E0E0] border-gray-300 dark:border-[#333333] focus:outline-none focus:ring-2 focus:ring-[#D4623A]"
                          placeholder="0.00"
                        />
                      </div>
                      <p className="text-xs #8A7060 mt-1">
                          ...
                          <button
                            ...
                            className={`p-3 rounded-xl border-2 font-medium capitalize transition-all ${
                              formData.preferredPayment === method
                                ? 'border-[#D4623A] bg-[#FDF1EC] dark:bg-[#D4623A]/15 text-[#D4623A]'
                                : '#E5D8CC dark:border-[#222222] #8A7060 dark:text-[#555555]'
                            }`}
                          >
                ...
                {!isCustomer && (
                  <>
                    <div className="#FAF7F3 dark:bg-[#1A1A1A]/50 p-6 rounded-xl border #E5D8CC dark:border-[#222222]">
                      <h3 className="font-bold #3D2B1A dark:text-[#E0E0E0] mb-4 flex items-center gap-2">
              ...
              <>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-[#1A1A1A] #3D2B1A dark:text-[#E0E0E0] border-gray-300 dark:border-[#333333] focus:outline-none focus:ring-2 focus:ring-[#D4623A] resize-none"
                    rows={4}
          ...
          {/* Actions */}
          <div className="flex gap-3 p-6 border-t #E5D8CC dark:border-[#222222] #FAF7F3 dark:bg-[#1A1A1A]/50">
            <button
              type="submit"
              disabled={loading || !isFormValid()}
              className={`flex-1 inline-flex items-center justify-center px-6 py-3 rounded-xl font-bold text-white transition-all ${
                isCustomer
                  ? 'bg-gradient-to-r from-[#D4623A] to-blue-700 hover:from-blue-700 hover:to-blue-800'
            ...
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="px-6 py-3 rounded-xl font-medium text-gray-700 dark:text-[#CCCCCC] bg-white dark:bg-[#1A1A1A] border-2 border-gray-300 dark:border-[#333333] hover:#FAF7F3 dark:hover:bg-gray-700 transition-colors"
            >
              {t('common.cancel')}
            </button>
          </div>
